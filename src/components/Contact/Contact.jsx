                  ...
                  <div className="flex items-center justify-between relative">
                    {formSteps.map((step, index) => (
                      <div key={index} className="flex flex-col items-center z-10">
                        <motion.div
                          className={`w-12 h-12 rounded-full flex items-center justify-center ${index === formStep ? 'bg-gradient-to-r from-red-600 to-red-400 text-white' : index < formStep ? 'bg-green-500 text-white' : 'bg-gray-100 text-gray-400'}`}
                          animate={{
                            scale: index === formStep ? 1.1 : 1,
                            boxShadow: index === formStep ? '0 0 15px rgba(239, 68, 68, 0.3)' : 'none'
                          }}
                        >
                          {index < formStep ? (
                            <motion.svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        ...
                        <span className={`text-xs mt-2 font-medium ${index === formStep ? 'text-red-500' : 'text-gray-500'}`}>
                          {step.title}
                        </span>
                      </div>
                    ))}
                    ...
                    <motion.div
                      className="absolute top-6 left-0 h-0.5 bg-gradient-to-r from-red-600 to-red-400 -z-10"
                      initial={{ width: '0%' }}
                  ...
                  {formSuccess ? (
                    ...
                    >
                          ...
                          <div>
                            ...
                            <div className="relative">
                              ...
                              <input
                                ...
                                className="pl-10 pr-4 py-3 w-full border border-gray-200 rounded-xl focus:ring-red-500 focus:border-red-500 shadow-sm"
                          ...
                          <div>
                            ...
                            <div className="relative">
                              ...
                              <select
                                ...
                                onChange={handleInputChange}
                                className="pl-10 pr-4 py-3 w-full border border-gray-200 rounded-xl focus:ring-red-500 focus:border-red-500 shadow-sm appearance-none"
                                required
                              >
                      ...
                      {formStep === 2 && (
                        <div className="space-y-4">
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-3">How would you like us to contact you?</label>
                            <div className="space-y-3">
                              <label className="flex items-center space-x-3 p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer">
                                <input
                                  type="checkbox"
                                  name="contactPhone"
                                  checked={formData.contactPhone || false}
                                  onChange={(e) => setFormData({ ...formData, contactPhone: e.target.checked })}
                                  className="h-4 w-4 text-red-500 focus:ring-red-500 border-gray-300 rounded"
                                />
                                <div>
                                  <p className="font-medium text-gray-700">Phone Call</p>
                                  <p className="text-sm text-gray-500">We'll call you during business hours</p>
                                </div>
                              </label>
                              ...
                              <label className="flex items-center space-x-3 p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer">
                                <input
                                  ...
                                  checked={formData.contactWhatsApp || false}
                              ...
                              <label className="flex items-center space-x-3 p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer">
                                <input
                                  type="checkbox"
                                  name="contactEmail"
                                  checked={formData.contactEmail || false}
                                  onChange={(e) => setFormData({ ...formData, contactEmail: e.target.checked })}
                                  className="h-4 w-4 text-red-500 focus:ring-red-500 border-gray-300 rounded"
                                />
                                <div>
                                  <p className="font-medium text-gray-700">Email</p>
                                  <p className="text-sm text-gray-500">Detailed information via email</p>
                                </div>
                              </label>
                            </div>
                            {!formData.contactPhone && !formData.contactWhatsApp && !formData.contactEmail && (
                          ...
                          <div className="pt-4">
                            <label className="flex items-start space-x-3">
                              <input
                                ...
                                className="h-4 w-4 mt-1 text-red-500 focus:ring-red-500 border-gray-300 rounded"
                                required
                              />
                              <span className="text-sm text-gray-500">
                                I agree to the <a href="#" className="text-red-500 hover:underline">Privacy Policy</a> and consent to being contacted regarding my inquiry.
                              </span>
                            </label>
                          </div>
                        </div>
                      ...
                      <div className="flex justify-between mt-8 pt-4 border-t border-gray-100">
                        {formStep > 0 ? (
                          <motion.button
                            ...
                            className="px-5 py-3 border border-gray-300 rounded-xl text-gray-700 hover:bg-gray-50 transition-all duration-300 font-medium"
                            whileHover={{ x: -2 }}
                            whileTap={{ scale: 0.98 }}
                          >
                            Back
                        ...
                        <motion.button
                          ...
                          disabled={isSubmitting || (formStep === 2 && !formData.contactPhone && !formData.contactWhatsApp && !formData.contactEmail)}
                          className={`px-6 py-3 rounded-xl ${isSubmitting ? 'bg-gray-400' : 'bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-400'} text-white font-medium transition-all duration-300 flex items-center gap-2 shadow-md`}
                          whileHover={{ x: formStep < formSteps.length - 1 ? 2 : 0, y: formStep === formSteps.length - 1 ? -2 : 0 }}
                          whileTap={{ scale: 0.98 }}
                        >
                          {isSubmitting ? (
                            <>
