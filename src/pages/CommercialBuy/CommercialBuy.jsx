...
const CommercialBuy = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        const category = location.pathname.includes('/commercial-buy') 
          ? 'Commercial Buy' 
          : 'Commercial Rent';
  ...
  // Dynamic heading
  const headingText = location.pathname.includes('/commercial-buy') 
      ...
      <div className="pt-0 px-4 md:px-0">
        ...
        <div className="container mx-auto p-4 md:px-0">
          {loading ? (
            ...
            <p>No commercial properties match your criteria.</p>
          ) : (
