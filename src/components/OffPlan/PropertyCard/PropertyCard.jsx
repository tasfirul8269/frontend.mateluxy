    ...
    <div onClick={handleClick} className="bg-white rounded-[20px] overflow-hidden hover:shadow-lg border border-[#e6e6e6] transition-all duration-300 cursor-pointer">
      ...
      <div className="p-5">
        ...
        <div className="flex justify-start items-center gap-2">
          <img src={locationImg} alt={property.propertyAddress} />
          <p className="mt-[5px] text-[#999999] font-medium text-[14px]">{property.propertyAddress}</p>
        </div>
        
        <div className="flex items-center gap-4 mb-4">
          <div className="flex items-center gap-1 text-gray-500">
            <Building2 className='text-[#256fff] mr-1' size={16} />
            <p className="mt-[5px] text-[#999999] font-medium text-[14px]">Developer : {property.developer}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="border border-[#f2f2f2] rounded-[8px] px-[10px] py-[5px]">
            ...
            <div className="text-[#00A3FF] font-medium text-[14px]">{property.propertySize} sq.ft</div>
          </div>
          <div className="border border-[#f2f2f2] rounded-[8px] px-[10px] py-[5px]">
            <div className="text-[12px] font-medium text-gray-500">Bedrooms</div>
            <div className="text-[#00A3FF] font-medium text-[14px]">{property.propertyBedrooms}</div>
          </div>
        </div>
