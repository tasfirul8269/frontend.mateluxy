...
import { Layout } from '@/components/AdminPannel/layout/Layout';
...
import { Header } from '@/components/AdminPannel/layout/Header';
import { 
  Table, 
  TableBody, 
  TableCell, 
...
import { Edit, MoreVertical, Trash2, Plus, FileText, Calendar, Tag } from 'lucide-react';
...
const NewsManagementPage = () => {
  ...
  const saveNews = async (formData) => {
    try {
      ...
      // Add content from the rich text editor
      const newsData = {
        ...formData,
        content
      };
                ...
                <div className="space-y-2">
                  ...
                  <div className="min-h-[200px]">
                    <ReactQuill 
                      ...
                      className="h-[200px] mb-12" // Add bottom margin for the toolbar
                    />
                  </div>
                  {!content && (
